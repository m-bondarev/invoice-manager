...
ALTER TABLE "ADMIN"."INVOICES" ADD CONSTRAINT "INVOICES_PK" PRIMARY KEY ("ID")
    USING INDEX  ENABLE;

ALTER TABLE "ADMIN"."INVOICES" ADD CONSTRAINT "NEW_FK_1" FOREIGN KEY ("USERID")
...
ALTER TABLE "ADMIN"."FILES" ADD CONSTRAINT "FILES_PK" PRIMARY KEY ("ID")
    USING INDEX  ENABLE;

ALTER TABLE "ADMIN"."FILES" ADD CONSTRAINT "NEW_FK_2" FOREIGN KEY ("INVOICEID")
